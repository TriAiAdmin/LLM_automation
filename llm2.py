...
def get_openai_response(base64_image,prompt):
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            company_code, invoice_type, invoice_no, po_number, invoice_date, invoice_amount, invoice_tax_amount, comment  = None, None, None, None, None, None, None, None
        return company_code, invoice_type, invoice_no, po_number, invoice_date, invoice_amount, invoice_tax_amount, comment
    else:
...
def process_files(batch_files):
    ...
    for file_name in batch_files:
        ...
        for image in images:
            ...
            company_code, invoice_type, invoice_no, po_number, invoice_date, invoice_amount, invoice_tax_amount, comment = get_openai_response(base64_image,prompt)
            if company_code or invoice_type or invoice_no or po_number  or invoice_date or invoice_amount or invoice_tax_amount:
